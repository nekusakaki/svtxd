...
class StatsFrame(Frame):
    ...
    def adjust_widgets(self):
        ...
        self.figures_notebook.add(self.wins_breakdown_frame, text='Wins')
        ...
        self.figures_notebook.add(self.second_breakdown_frame, text='Second')
