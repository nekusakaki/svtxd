...
class MainApplication(tk.Frame):
    ...
    def configure_gui(self):
        ...
        self.master.title("ShadowVerse Deck Tracker XD")
...
class CardDisplay(tk.Frame):
    ...
    def __init__(self, master, mydeck, decklist, card_db, gui_disp_options, **kwargs):
        ...
        if display.lower() in ['followers', 'units', '0', 'monsters', 0]:
            self.disp_type = 0
        ...
        elif display.lower() in ['amulets', 'count amulets', 'sigil', 'sigils', '2', 2]:
            self.disp_type = 2
            self.section_label = 'Amulet'
